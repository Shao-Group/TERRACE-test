...
def calculate(gene_id,chr_name,match_num_total,head_num,inputfrag_len,tempfile_path):
	...
	i = 0
	if chr_name[0:3] != "chr":
		new_name = "chr" + chr_name
	else:
		new_name = chr_name
	in_sam = open(tempfile_path + "selected_" + new_name + "_A.sam","r")
	...
	if chr_name[0:3] != "chr":
		...
		new_name = chr_name
	in_sam = open(tempfile_path + "selected_" + new_name + "_B.sam","r") 
...
parse.add_option('-J','--junction',dest = 'junction',action = 'store',metavar = 'circRNA junction list',help = 'please enter a circRNA junction list generated by CIRCexplorer2, WWCIRI and UROBORUS or  or other tools in a given format')
